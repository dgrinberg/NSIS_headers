...
;
; ${If} ${HasDotNet2.0}
;    ${If} ${DOTNETVER_2_0} AtLeastDotNetServicePack 1
;        DetailPrint "Microsoft .NET Framework 2.0 SP1 installed. No update necessary."
;    ${Else}
;        DetailPrint "Microsoft .NET Framework 2.0 SP1 not installed. Please install before trying install again"
;    ${EndIf}
; ${EndIf}
